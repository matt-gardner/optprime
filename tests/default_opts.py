...
def default_specex_opts():
    ...
    opts.spec = 'specmethod.ReproducePSO'
    opts.func__dims = 2
    ...
    opts.pruner = 'specmethod.OneCompleteIteration'
    ...
    opts.motion = 'motion.basic.Constricted'
    opts.transitive_best = False
    opts.func = 'functions.sphere.Sphere'
    return opts
